...
# embed_dims = 1536
# openai_base_url = "http://localhost:1234/v1"  # local OpenAI-compatible server (no API key needed for localhost)
...
class Config:
    ...
    embed_dims: int = 1536
    openai_base_url: str = (
        ""  # custom OpenAI-compatible endpoint (e.g. local LM Studio)
    )
